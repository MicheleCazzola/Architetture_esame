...
int main (void) {
  ...
  BUTTON_init();												/* BUTTON Initialization              */
	...
	init_timer(0, 0x0003D090);						/* TIMER0 Initialization 10 ms with f = 25 MHz		*/
	init_timer(1, 0x0003D090);						/* TIMER1 Initialization 10 ms with f = 25 MHz		*/
	init_timer(2, 0x12A05F20);						/* TIMER2 Initialization 12.5 ms with f = 25 MHz		*/
