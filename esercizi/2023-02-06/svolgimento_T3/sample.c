...
int main (void) {
  ...
  BUTTON_init();												/* BUTTON Initialization              */
	...
	init_timer(0, 0x005F5E10);						/* TIMER0 Initialization 250 ms with f = 25 MHz		*/
	init_timer(1, 0x003F940B);						/* TIMER1 Initialization 167 ms with f = 25 MHz		*/
	init_timer(2, 0xFD51DA80);						/* TIMER2 Initialization 2 min 50 s with f = 25 MHz		*/
