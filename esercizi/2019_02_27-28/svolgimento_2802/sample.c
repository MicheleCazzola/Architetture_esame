...
int main (void) {
  ...
  BUTTON_init();												/* BUTTON Initialization              */
	...
	//init_timer(0, 0x59682F00);						/* TIMER0 Initialization 60 s with f = 25 MHz		*/
	init_timer(0, 0x054F8EE0);						/* TIMER0 Initialization 3.564 s with f = 25 MHz		*/
	init_timer(3, 0x017D7840);						/* TIMER3 Initialization 1 s with f = 25 MHz		*/
