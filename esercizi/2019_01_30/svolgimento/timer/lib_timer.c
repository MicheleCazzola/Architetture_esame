...
//*** <<< end of configuration section >>>    ***
		...
		NVIC_SetPriority(TIMER0_IRQn, 0);		/* same priority as rit */
		return (1);
  }
  else if (timer_num == 1)
  {
		...
		NVIC_SetPriority(TIMER1_IRQn, 0);	/* same priority as rit*/
		return (1);
  }
	else if (timer_num == 2)
  {
	...
	else if(timer_num == 3)
  {
		...
		NVIC_SetPriority(TIMER3_IRQn, 0);	/* same priority as rit*/
		return (1);
  }
  return (0);
}
