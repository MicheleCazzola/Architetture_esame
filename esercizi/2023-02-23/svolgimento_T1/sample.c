...
int main (void) {
  ...
  BUTTON_init();												/* BUTTON Initialization              */
	...
	init_timer(0, 0x007270E0);						/* TIMER0 Initialization 0.3 s with f = 25 MHz		*/
	init_timer(1, 0x047868C0);						/* TIMER1 Initialization 3 s with f = 25 MHz		*/
	init_timer(2, 0x00393870);						/* TIMER2 Initialization 0.15 s with f = 25 MHz		*/
