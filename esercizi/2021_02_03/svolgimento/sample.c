...
int main (void) {
  ...
  BUTTON_init();												/* BUTTON Initialization              */
	init_RIT(0x002625A0);									/* RIT initialization to 25 ms with f = 100 MHz			*/
	init_timer(0, 0x02FAF080);						/* TIMER0 Initialization 2 s with f = 25 MHz		*/
	init_timer(3, 0x00BEBC20);						/* TIMER3 Initialization 1 s with f = 12.5 MHz		*/
